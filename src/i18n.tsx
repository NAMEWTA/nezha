...
const translations: Record<AppLanguage, Record<string, string>> = {
  en: {
    ...
    "settings.projectNameHint": "Display name used throughout Nezha",
    "settings.projectPath": "Project Path",
    "settings.resetProjectName": "Reset",
    ...
    "project.nameTooLong": "Project name must be {max} characters or fewer.",
  ...
  zh: {
    ...
    "settings.projectNameHint": "Nezha 中展示的项目显示名",
    "settings.projectPath": "项目路径",
    "settings.resetProjectName": "重置",
    "settings.agent": "智能体",
    ...
    "project.nameTooLong": "项目名称不能超过 {max} 个字符。",
