...
const translations: Record<AppLanguage, Record<string, string>> = {
  en: {
    ...
    "appSettings.navigationShortcuts": "Navigation",
    "appSettings.shortcutAction.switch_project_slot": "Switch Project Slot",
    "appSettings.shortcutAction.switch_task_slot": "Switch Task Slot",
    "appSettings.shortcutAction.new_task": "New Task",
    "appSettings.shortcutAction.open_project_switcher": "Open Project Switcher",
    "appSettings.shortcutHint.switch_project_slot": "Switches to the first 9 visible projects in the project rail.",
    "appSettings.shortcutHint.switch_task_slot": "Switches to the first 9 visible tasks in the current filtered task list.",
    "appSettings.shortcutHint.new_task": "Opens the new task composer for the current project.",
    "appSettings.shortcutHint.open_project_switcher": "Opens the project drawer from the project rail.",
    "appSettings.shortcutRecording": "Press keys",
    "appSettings.shortcutRecordHint": "Press a shortcut, or Esc to cancel.",
    "appSettings.shortcutRecordNeedsModifier": "Use at least one modifier key.",
    "appSettings.shortcutRecordNeedsDigit": "Use a number from 1 to 9 for slot shortcuts.",
    "appSettings.shortcutConflict": "Conflicts with {action}.",
    "appSettings.shortcutSendConflict": "Conflicts with the send message shortcut.",
    "appSettings.shortcutFixedConflict": "Conflicts with a fixed app shortcut.",
    "appSettings.shortcutMacCtrlDigitWarning":
      "macOS may reserve Ctrl + number for Mission Control Spaces.",
  ...
  zh: {
    ...
    "appSettings.navigationShortcuts": "导航",
    "appSettings.shortcutAction.switch_project_slot": "切换项目槽位",
    "appSettings.shortcutAction.switch_task_slot": "切换任务槽位",
    "appSettings.shortcutAction.new_task": "新建任务",
    "appSettings.shortcutAction.open_project_switcher": "打开项目切换器",
    "appSettings.shortcutHint.switch_project_slot": "切换到项目栏中前 9 个可见项目。",
    "appSettings.shortcutHint.switch_task_slot": "切换到当前筛选后的任务列表前 9 个任务。",
    "appSettings.shortcutHint.new_task": "打开当前项目的新建任务编辑器。",
    "appSettings.shortcutHint.open_project_switcher": "打开项目栏中的项目抽屉。",
    "appSettings.shortcutRecording": "按下快捷键",
    "appSettings.shortcutRecordHint": "按下一个快捷键，或按 Esc 取消。",
    "appSettings.shortcutRecordNeedsModifier": "至少需要包含一个修饰键。",
    "appSettings.shortcutRecordNeedsDigit": "槽位快捷键需要使用 1 到 9 的数字。",
    "appSettings.shortcutConflict": "与 {action} 冲突。",
    "appSettings.shortcutSendConflict": "与发送消息快捷键冲突。",
    "appSettings.shortcutFixedConflict": "与应用固定快捷键冲突。",
    "appSettings.shortcutMacCtrlDigitWarning": "macOS 可能将 Ctrl + 数字保留给 Mission Control 空间切换。",
